...
public class LargePaleBlock extends BlockWithEntity implements Waterloggable {
    ...
    public void onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        BlockEntity blockEntity = world.getBlockEntity(pos);
        if (blockEntity instanceof LargePaleBlockEntity paleBlockEntity) {
            if (!world.isClient && player.isCreative() && !paleBlockEntity.isEmpty()) {
                ItemStack itemStack = new ItemStack(this);
                blockEntity.setStackNbt(itemStack);
                if (paleBlockEntity.hasCustomName()) {
                    itemStack.setCustomName(paleBlockEntity.getCustomName());
                }
                ...
                paleBlockEntity.checkLootInteraction(player);
            }
        }
