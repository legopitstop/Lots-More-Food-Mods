...
public class ModHangingCropBlock extends PlantBlock implements Fertilizable {
    ...
    private final Block SAPLING_BLOCK;
    private final String CROP_ITEM;

    public ModHangingCropBlock(String cropItem, Block saplingBlock, Settings settings) {
        super(settings);
        this.SAPLING_BLOCK = saplingBlock;
    ...
    protected ItemConvertible getSaplingItem() {
        return this.SAPLING_BLOCK.asItem();
    }
