...
public class StrawberryBush extends MoreFoodBush {
    public StrawberryBush(Properties p_51021_) {
        super(p_51021_);
    }

    @Override
    public ItemStack getCloneItemStack(BlockGetter p_57256_, BlockPos p_57257_, BlockState p_57258_) {
        return new ItemStack(MoreFoodItems.STRAWBERRY_SEEDS.get());
    }
    ...
    public InteractionResult use(BlockState p_57275_, Level p_57276_, BlockPos p_57277_, Player p_57278_, InteractionHand p_57279_, BlockHitResult p_57280_) {
        ...
        if (!flag && p_57278_.getItemInHand(p_57279_).is(Items.BONE_MEAL)) {
            ...
            popResource(p_57276_, p_57277_, new ItemStack(MoreFoodItems.STRAWBERRY.get(), j + (flag ? 1 : 0)));
